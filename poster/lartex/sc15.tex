...
\huge \textbf{Milinda Fernando \& Hari Sundar (Advisor)}\\ % Author(s)
\huge School of Computing, University of Utah \\ % University/organization
\end{minipage}
\begin{textblock}{2}(12,-2.6)
...
\centering
\includegraphics[width=8cm]{qr.pdf}
\end{wrapfigure}
